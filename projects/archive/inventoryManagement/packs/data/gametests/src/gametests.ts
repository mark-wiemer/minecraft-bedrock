...
// Gametests use mojang-minecraft since they depend on Minecraft functionality
import { BlockLocation } from 'mojang-minecraft';

type Spec = (arg: GameTest.Test) => void;

const simpleMobTest: Spec = (test: GameTest.Test) => {
